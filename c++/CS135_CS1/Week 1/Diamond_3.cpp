...
int main()
    ...
    */
    ...
    // Output line 1
    printStringAt( 40, 3, "*****", "LEFT" );

    // Output line 2
    printStringAt( 40, 4, "*****", "LEFT" );

    // Output line 3
    printStringAt( 40, 5, "*****", "LEFT" );

    // Print second box right justified at location 40
    // Output line 1
    printStringAt( 40, 8, "*   ", "RIGHT" );

    // Output line 2
    printStringAt( 40, 9, "***  ", "RIGHT" );

    // Output line 3
    printStringAt( 40, 10, "***** ", "RIGHT" );
 
    //Output line 4
    printStringAt( 40, 11, "***  ", "RIGHT");

    //Output line 5
    printStringAt( 40, 12, "*   ", "RIGHT");
