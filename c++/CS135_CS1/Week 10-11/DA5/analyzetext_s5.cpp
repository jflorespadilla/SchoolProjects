...
int calcWordNum( ifstream &fin )
    {
     ...
     // Prime the loop with fin value assignment
     // Pre-test loop with .good conditon
        // pre-test loop with isLetter conditon
           // increment a counter and update index condtiton
     
     // add all values when loops are done
...
// initialize variables
     ...
     // Pre-test loop with .good conditon
        // pre-test loop with isLetter conditon
           // increment a counter and index count and update index condtiton
     
     // add all counter values when done and divide by adde index count
        // operation: math
...
void prntUpperCaseData( int letterCount, int XPos, int YPos, char array[] )
   {
    ...
    // divide letter count by 2

    // If statement
    // pre-test loop
      // print character on screen
         // Function: printCharAt ( Increment for each X and y position )
   }
...
void countLetters( ifstream &fin, char array[] )
   {
    ...
    // pre-test loop with .good condition
       // If statement
       // If isLetter
          // variable character will store number value at each indes
